...
class Talent : public cocos2d::Layer , public LayerBase
{
	class Item;
public:
	CREATE_FUNC(Talent);
...
private:
    ...
    cocos2d::Value  preTalentData = cocos2d::Value();
    
};

class Talent::Item : public cocos2d::ui::Layout
{
public:
	/**
	*  创建一个列表项
	...
	*/
	static Item *create(cocos2d::ValueMap itemData, Talent *delegate);
